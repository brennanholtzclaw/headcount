...
class EconomicProfileTest < Minitest::Test
  ...
  def test_it_finds_reduced_price_meal_data_in_year
    ...
    assert_equal 0.127, epr.find_by_name("ACADEMY 20").free_or_reduced_price_lunch_in_year(2014)
  end
  ...
  def test_it_raises_error_if_unknown_year_for_free_meals_in_year
    ...
    assert_raises "UnknownDataError" do
      epr.find_by_name("ACADEMY 20").free_or_reduced_price_lunch_in_year(20094)
    end
  end
  ...
  def test_it_finds_reduced_price_meal_numbers_in_year
    ...
    assert_equal 3006, epr.find_by_name("ACADEMY 20").free_or_reduced_price_lunch_total_in_year(2012)
  end
  ...
  def test_it_raises_error_if_unknown_year_for_free_meals_in_year
    ...
    assert_raises "UnknownDataError" do
      epr.find_by_name("ACADEMY 20").free_or_reduced_price_lunch_total_in_year(20857)
    end
  end
